...
function TestUtil.simuLoginReward()
    tx.userData.loginReward = {
        ...
        vipRewardTips = {
            tips = "ยินดีด้วยค่ะ ท่านได้รับ 1000 ชิป + ตั๋วห้องชิงชิปเงินสด 800 บาท 7 ใบ +  ค่าเสน่ห์ 50 แต้ม"
        }
    }
end
...
function TestUtil.compareLangResource()
    ...
    print("======= th not exists ========")
    sa.LangUtil.compareResource(cn, th, "L")
    print("======= cn not exists ========")
    sa.LangUtil.compareResource(th, cn, "L")
    print("=========== end  =============")

    print("======= vn not exists ========")
    sa.LangUtil.compareResource(cn, vn, "L")
    print("======= cn not exists ========")
    sa.LangUtil.compareResource(vn, cn, "L")
    print("=========== end  =============")

    print("======= en not exists ========")
    sa.LangUtil.compareResource(cn, en, "L")
    print("======= cn not exists ========")
    sa.LangUtil.compareResource(en, cn, "L")
    print("=========== end  =============")
end
