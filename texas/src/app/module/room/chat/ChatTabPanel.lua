...
function ChatTabPanel:ctor(tabTitleLeft, tabTitleRight, customTab)
    self.background_ = display.newScale9Sprite("#common/pop_sec_bg.png", 0, 0, cc.size(ChatTabPanel.WIDTH+16, ChatTabPanel.HEIGHT))
    ...
    if customTab==false then
        ...
        local icon = {
                    {"#common/room_chat_fast.png", "#common/room_chat_fast_select.png"}, 
                    {"#common/room_chat_record.png", "#common/room_chat_record_select.png"}
                }
        ...
        self.mainTabBar_ = RoomPopupTabBar.new(
            {
                ...
                iconOffsetX = 10, 
                iconTexture = icon,
                btnText = sa.LangUtil.getText("ROOM", "CHAT_MAIN_TAB_TEXT")
            }
        )
