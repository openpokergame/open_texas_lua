...
RoomBatteryIndicator.MAX_VAL = 26;
...
function RoomBatteryIndicator:ctor()
	self.batteryBg_ = display.newSprite("#commonroom/battery_out.png"):addTo(self);
	self.batteryBar_ = display.newScale9Sprite("#commonroom/battery_in.png", 0, 0, cc.size(RoomBatteryIndicator.MIN_VAL, RoomBatteryIndicator.HEIGHT))
						:pos(-14, 0)
						:addTo(self);
