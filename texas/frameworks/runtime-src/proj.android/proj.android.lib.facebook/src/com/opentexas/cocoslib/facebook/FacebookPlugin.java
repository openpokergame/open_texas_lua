package com.opentexas.cocoslib.facebook;
...
//        }
    ...
    public void statisticsFBADPay(String num, String code) {
        if (this.logger == null) {
            logger = AppEventsLogger.newLogger(Cocos2dxActivityWrapper.getContext());
        }
        logger.logPurchase(BigDecimal.valueOf(Float.valueOf(num)), Currency.getInstance(code));
    }
