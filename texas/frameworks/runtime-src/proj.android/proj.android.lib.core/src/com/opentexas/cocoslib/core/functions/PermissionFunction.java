...
public final class PermissionFunction {
    ...
    public static void requestStoragePermission() {
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(ctx, STORAGE[1]) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions((Activity) ctx, STORAGE, 1);
            }
        }
    }
}
